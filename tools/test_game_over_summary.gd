...
func _run() -> void:
	...
	for required_key in ["victory_reason", "army_trained", "buildings_lost", "resources_gathered"]:
	...
	for required_row in ["Army Produced", "Units Killed", "Units Lost", "Buildings Lost", "Resources Gathered"]:
